...
- Name: site-analysis.spec.ts >> Full site analysis - desktop >> Worlds, Artist, Collections pages
- Location: playwright-tests/site-analysis.spec.ts:130:3
...
- generic [active] [ref=e1]:
  ...
  - link /Wang_art/worlds/ [ref=e2] [cursor=pointer]:
    - /url: /Wang_art/worlds/
  - text: instead?
```
