      ...
      <section class="contact-container contact-info">
        ...
        <div class="contact-block contact-block--contact">
          ...
          <div class="contact-lines">
            <a href="${a}" class="contact-row contact-email-link">${o}</a>
            <a
              href="${c}"
              target="_blank"
              rel="noopener noreferrer"
